 ...
 *
 */
public interface PortalFuncMapper {    
     ...
     * @return
     */
    List<PortalFunc> getChildFuncs(Map<String,Object> map);
    
    List<PortalFunc> getEffectChildFuncs(Map<String,Object> map);
    ...
    List<PortalFunc> getEffectRoleChildFuncs(Map<String,Object> map);
